...
class Database:
    ...
    def update(self, child, parent):
        self.parents[child] = parent
        if self.ranks[parent] == self.ranks[child]:
            self.ranks[parent] += 1

        self.row_counts[parent] += self.row_counts[child]
    ...
    def update_max(self, changed_parent):
        self.max_row_count = max(self.max_row_count, self.row_counts[changed_parent])
